...
import { CATEGORY_CONFIG, DIFFICULTY_CONFIG, formatExp } from '@/utils/task'
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0 }}>
        <span style={{ fontSize: 11, padding: '2px 8px', borderRadius: 20, color: category.color, background: category.bg, fontWeight: 500 }}>
          {category.icon} {category.label}
        </span>
        <span style={{ fontSize: 11, padding: '2px 8px', borderRadius: 20, color: difficulty.color, background: difficulty.bg, fontWeight: 500 }}>
